...
<body>
	<div>
		...
		<div class="tab">
			<button class="tablinks" onclick="openTab(event, 'first', 'tabcontent')">Bài 1</button>
			<button class="tablinks" onclick="openTab(event, 'second', 'tabcontent')">Bài 2</button>
			<button class="tablinks" onclick="openTab(event, 'third', 'tabcontent')">Bài 3</button>
			<button class="tablinks" onclick="openTab(event, '', 'tabcontent')">Đóng</button>
		</div>
	...
	<div class="tab">
		<button class="tablinks" onclick="openTab(event, 'fourth', 'tabcontent_2')">Bài 1</button>
		<button class="tablinks" onclick="openTab(event, 'fifth', 'tabcontent_2')">Bài 2</button>
		<button class="tablinks" onclick="openTab(event, '', 'tabcontent_2')">Đóng</button>
	</div>
